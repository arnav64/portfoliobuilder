...
class Home extends React.Component {
  ...
  async componentDidMount() {
    ...
    this.setState({
        average_valuation: [<option> select valuation </option>,<option>250000</option>,<option>500000</option>,<option>750000</option>,<option>1000000</option>,<option>2000000</option>,<option>4000000</option>,<option>6000000</option>,<option>8000000</option>,
        <option>10000000</option>,<option>50000000</option>,<option>100000000</option>,<option>1000000000</option>,<option>7000000000</option>]
      });
  } 	
  ...
  handleChangeValuation(e) {
    ...
    this.setState({
      selected_valuation: e.target.value
    });
  }
